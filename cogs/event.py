...
class Event(commands.Cog):
    ...
    async def on_message(self,message:discord.Message):
        ...
        # word='笑鼠'
        # word11='哈哈'
        # url1=['https://memeprod.sgp1.digitaloceanspaces.com/user-wtf/1611839865041.jpg','https://cdn.snsimg.carview.co.jp/minkara/userstorage/000/062/019/278/80cef4fe7c.jpg','https://memeprod.ap-south-1.linodeobjects.com/user-template/8033ffd8b66053cc9ab07c53d7652654.png']
        ...
        # word3='並沒有'
        # url3=['https://memeprod.sgp1.digitaloceanspaces.com/user-resource/a31207a4daab475e4d64655ea6577364.png','https://i.imgur.com/LTMTlj8.jpg','https://cdn2.ettoday.net/images/3420/d3420288.jpg']
        ...
        # word11='不要瞎掰好嗎'
        # url11=["https://cdn2.ettoday.net/images/3420/d3420289.jpg"]
        # if(word11 in message.content):
        #     x=random.randint(0,len(url11)-1)
        #     await message.channel.send(f"{url11[x]}")
