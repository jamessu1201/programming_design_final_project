...
class Event(commands.Cog):
    ...
    async def on_message(self,message:discord.Message):
        ...
        word='笑鼠'
        word11='哈哈'
        url1=['https://memeprod.sgp1.digitaloceanspaces.com/user-wtf/1611839865041.jpg','https://imgur.dcard.tw/Fr6zOj0.png','https://memeprod.ap-south-1.linodeobjects.com/user-template/8033ffd8b66053cc9ab07c53d7652654.png']
