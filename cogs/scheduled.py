# -*- coding: utf-8 -*-
"""User-defined scheduled text messages, fired by cron expressions."""
    ...
    async def tick(self):
        ...
        for guild_id_str, entries in list(data.items()):
            for entry in entries:
                # Skip anything that looks like a legacy built-in entry
                # from the earlier type-based design.
                if entry.get("type") and entry["type"] != "text":
                    continue
